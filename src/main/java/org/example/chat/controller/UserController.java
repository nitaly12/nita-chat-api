...
public class UserController {
    ...
    public ResponseEntity<UserResponse> deleteAvatar(@AuthenticationPrincipal UserDetails principal) {
        return ResponseEntity.ok(userService.removeAvatar(principal.getUsername()));
    }
}
